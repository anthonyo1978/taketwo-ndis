      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          ...
          >
            ...
            <p className="text-gray-600 text-sm mb-4">Manage recurring transactions, scheduled billing, and system jobs.</p>
            <div className="text-blue-600 text-sm font-medium hover:text-blue-800">
              Go to Automations →
            </div>
          </Link>
          ...
          >
            ...
            <p className="text-gray-600 text-sm mb-4">Configure your dashboard.</p>
            <div className="text-blue-600 text-sm font-medium hover:text-blue-800">
              Configure →
            </div>
          </Link>
