...
interface ResidentSearchAndFilterProps {
  searchValue: string
...
/**
 * Search and filter component for resident data tables.
 ...
 */
export function ResidentSearchAndFilter({
  searchValue,
  onSearchChange,
  statusValue,
  onStatusChange,
